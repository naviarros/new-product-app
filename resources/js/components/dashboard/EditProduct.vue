    ...
    <div>
        ...
        <form @submit.prevent="updateProduct" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea
                    v-model="model.products.description"
                    class="form-control"
...
export default {
    setup() {
        ...
        const fetchProductDetails = async () => {
            try {
                const response = await axios.get(
                    `/api/products/edit/${productId.value}`,
                    {
                        headers: {
        ...
        const updateProduct = async () => {
            try {
                const { id, name, category, description, date_time, images } =
        ...
        onMounted(() => {
            ...
            console.log(
                "Component Mounted - Initial Product ID:",
                productId.value
            );
            fetchProductDetails();
        });
